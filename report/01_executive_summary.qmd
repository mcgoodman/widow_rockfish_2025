...
The most recent benchmark assessment was conducted in 2015 [@hicks_status_2015] which was then updated in 2019 [@adams_status_2019]. This assessment began as a second update of the 2015 benchmark stock assessment and was initially reviewed by the Pacific Fishery Management Council (PFMC) Science and Statistical Committee (SSC) Groundfish Subcommittee (GFSC) in August 2025. The GFSC requested additional explorations and changes to be reviewed in October 2025 and then again in January 2026. Many of those changes are outside the scope of the update assessment terms of reference, making this assessment closer to a benchmark assessment.
