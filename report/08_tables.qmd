...
<!-- library(dplyr) -->
<!-- library(tidyr) -->
<!-- ManageTable<- read.csv(file.path(here(),"report/tables/Table_3_2025.csv")) -->
...
#| echo: false
#| warning: false
#| tbl-cap: "Recent trend in the overfishing limits (OFLs), the acceptable biological catches (ABCs), the annual catch limits (ACLs), the total landings, and total mortality all in metric tons (mt)."
...
table16 <- read.csv(here("report", "tables", "table_16_data.csv"))
#Remove periods
...
table6_data <- read.csv(here("data_provided", "2019_assessment", "triennial_ranges.csv"))
...
table7_triennial_data <- read.csv(here("data_provided", "2019_assessment", "triennial_strata.csv"))
...
table20 <- read.csv(here("data_provided", "2019_assessment", "aging_error.csv"))
...
table21<- openxlsx::read.xlsx(here("report", "tables", "table_21.xlsx"))
...
#| echo: false
#| warning: false
#| tbl-cap: "Parameter estimates, estimation phase, parameter bounds (low, high), estimation status, estimated standard deviation (SD), prior information [distribution(mean, SD)] used in the base model."

table_pars <- read_rdata(here("report", "tables", "table_pars.rda"))$table

flextable(table_pars) %>% port_tab_style (wd=0.85)
```
\blandscape
```{r}
...
# Function for consistent table styling
table23 <- read.csv(here("report", "tables", "table_23.csv"))
...
# Function for consistent table styling
table24 <- read.csv(here("report", "tables", "table_24.csv"))
...
# Function for consistent table styling
table25 <- read.csv(here("report", "tables", "table_25.csv"))
# rounding up front
...
# Function for consistent table styling
table27 <- read.csv(here("report" , "tables", "table_27.csv"))
# build in rounding
...
table29 <- read.csv(here("report", "tables", "short_sens_table.csv"))
#Remove periods
