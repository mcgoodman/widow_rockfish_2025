...
table_c <- read_rdata(here("report", "tables", "exec_summ_tables", "recr_es.rda"))$table
...
table_e <- read_rdata(here("report", "tables", "exec_summ_tables", "reference_points.rda"))$table
...
table_g <- read_rdata(here("report", "tables", "exec_summ_tables", "projections.rda"))$table
table_g <- round(table_g, 3)
