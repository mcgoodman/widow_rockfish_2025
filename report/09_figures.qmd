...
#| warning: false
#| eval: true
#| fig-cap: "Fits (lines) to the abundance estimates (points) for the base model. A separate q is estimated for the Hake series starting in 1991. Juvenile survey index (in numbers) is on the bottom. 95% confidence intervals are shown in the input standard errors. Thicker lines (if present) indicate input uncertainty before addition of the estimated additional uncertainty parameter."
#| out.width: "90%"
#| fig-align: "center"
...
#| warning: false
#| eval: true
#| fig-cap: "Estimated retention curves by time block (if applicable) for each of the five fleets in the model."
#| out.width: "90%"
#| fig-align: "center"
