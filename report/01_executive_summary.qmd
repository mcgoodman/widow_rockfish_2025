...
The most recent benchmark assessment was conducted in 2015 [@hicks_status_2015] which was then updated in 2019 [@adams_status_2019]. This assessment began as a second update of the 2015 benchmark stock assessment and was initially reviewed by the Pacific Fishery Management Council (PFMC) Science and Statistical Committee (SSC) Groundfish Subcommittee (GFSC) in August 2025. The GFSC requested additional explorations and changes to be reviewed in October 2025. For the October 2025 supplemental review, the stock assessment team (STAT) provided all the requested materials, but due to the United States federal government shutdown that lasted between October 1, 2015 and November 12, 2025, the STAT and SSC members who are federal employees were unable to participate in the review meeting. At the subsequent November 2025 PFMC meeting, the SSC requested another review of the widow rockfish assessment to allow for full participation of the STAT and SSC members. Many of the changes made after the August 2025 model are outside the scope of the update assessment Terms of Reference, which resulted in more parsimonious model raised to the current best practices in West Coast groundfish stock assessments.
