...
Data on discards on Widow Rockfish are available from three different sources. Historical sources included [@pikitch_life_1989] and Enhanced Data Collected Project (EDCP, Sampson 2002). These historical sources were not reanalyzed for this update assessment, and discard amounts were not changed from the last assessment. Sex-specific length frequencies were also available from [@pikitch_life_1989]. Discard estimates are shown in @tbl-disc-totals and range from 463 to 1,847 mt. Length compositions for discards show a wide range of sizes being discarded, with a peak around 40 cm (@fig-disccomps-pikitch). 
