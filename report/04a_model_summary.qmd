...
The specifications of the assessment are listed in @tbl-speci-base-assess and are not changed from the 2019 assessment, except by updating data, the prior on natural mortality, time blocks on selectivity and retention parameters, and other routine model bridging steps.
