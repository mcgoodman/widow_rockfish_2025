...
Spawning output is estimated to be at `r format(SSB$Value[SSB$Year == 2025], big.mark = ",", digits = 1)` billions of eggs in 2025 (95% confidence interval of `r paste(format(table_b[table_b$Year == 2025, c("SSB_Lwr", "SSB_Upr")], big.mark = ",", digits = 1), collapse = " - ")` billions of eggs). The uncertainty in the estimated spawning output is high, especially in the early years. 
