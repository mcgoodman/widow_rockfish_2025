...
% Title and subtitle
{\huge\bfseries\nohyphens{$title$}\par}%\\[1\baselineskip]
...
%%%%%% Cover image
$if(cover)$
\pdftooltip{\includegraphics[width=4.5in]{$cover$}}{An illustration of Widow rockfish}
...
$if(by-affiliation.address)$, $else$$if(by-affiliation.department)$, $endif$$endif$%
