...
#| echo: false
#| warning: false
#| tbl-cap: "Recent total catch for the bottom trawl, midwater trawl, hake fleets. Catch combines landings and discards. Te bottom trawl catch includes contributes from fleets that were previously separated as net, and hook-and-line fisheries as described in the model bridging section."
...
The time series of estimated spawning output and the fraction of unfished spawning output is in @fig-b and @fig-c, respectively, and for the most recent year in @tbl-b. The spawning output declined rapidly with the developing domestic midwater fishery in the late 1970s and early 1980s, and remained low until 2000. A combination of strong recruitment and low catches resulted in a steady increase in spawning output through 2016. A target fishery for widow rockfish was reestablished in 2017. The stock exhibits a decline in most recent years with the increased catches since 2017.
...
spawning output is estimated to be at `r format(SSB$Value[SSB$Year == 2025], big.mark = ",", digits = 1)` billion eggs in 2025 (95% confidence interval of `r paste(format(table_b[table_b$Year == 2025, c("SSB_Lwr", "SSB_Upr")], big.mark = ",", digits = 1), collapse = " - ")` billion eggs). The uncertainty in the estimated spawning output is high, especially in the early years. 
...
#| warning: false
#| eval: true
#| fig-cap: "Estimated relative spawning output (depletion) with asymptotic 95% confidence interval (dashed lines) for the base case assessment model."
#| out.width: "90%"
#| fig-align: "center"
...
DECISION TABLE TO BE ADDED LATER
