...
Sensitivity analysis was performed to determine the model behavior under different assumptions than those of the base case model. Broad range of sensitivity runs were conducted at multiple stages of the assessment. Here, we present only selected runs conducted:
