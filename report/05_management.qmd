...
While the estimate of population scale has remained relatively steady across the 2015, 2019, and 2025 assessments, natural mortality (M) have declined from 2015 (female M of 0.157 yr^-1^) to 2019 (0.144 yr^-1^) to 2025 (`r round(report$M_at_age[1, 4], 3)` yr^-1^), reflecting the increase of the number of older fish in the population throughout rebuilding years. Thus, although the population scale is estimated consistently, additional years of data (in particular, age composition data) following the re-opening of the fishery have led the model to estimate that the population is less productive, which results in lower yields at all three reference points (proxy based on spawning output, proxy based on fishing intensity, and model estimate of MSY). Also, the model did not support  large 2013 year class previously estimated in the 2019 assessment, which contributed to decrease in of stock productivity and estimated overfishing limits (OFLs).
