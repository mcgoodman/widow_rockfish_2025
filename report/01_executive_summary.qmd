...
#| echo: false
#| warning: false
#| tbl-cap: "Recent total catch for the bottom trawl, midwater trawl, at-sea hake. Catch combines landings and discards. Te bottom trawl catch includes contributes from fleets that were previously separated as net, and hook-and-line fisheries as described in the model bridging section."
...
#| warning: false
#| eval: true
#| fig-cap: "Total catches (landings and discards combined) of widow rockfish from 1916 to 2024 for bottom trawl, midwater trawl, and at-sea hake fleets"
#| out.width: "90%"
#| fig-align: "center"
