...
Forcing asymptotic selectivity on the midwater fleet decreased estimated SSB in the early years, but had little effect in recent years. Forcing logistic selectivity on the \gls{s-wcgbt} increased peak SSB estimates in 2017 but likely had little effect on recent estimates. Excluding the triennial survey decreased estimated spawning biomass dramatically and decreased recruitment deviations in the 2019-2025 period [@fig-recdevs-sens]. Updating WA catch reconstruction and adding shrimp trawl data to the historical landings had almost no impact on the estimated spawning biomass. 
