...
- **Updating the log-SD of the prior for natural mortality** based on @hamel_development_2022. The log-mean remained unchanged while the log-SD has been decreased from 0.44 to 0.31.
