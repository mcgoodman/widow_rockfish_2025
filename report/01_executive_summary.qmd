...
#Old table 12
table_A <- read_rdata(here("report", "tables", "exec_summ_tables", "catches_es.rda"))$table

table_A |>
  dplyr::select(-dplyr::starts_with("ignore")) |> # remove columns formerly used for net and hook-and-line catch that are now included in the bottom trawl catch
  gt::gt() |>
  gt::fmt_number(
...
#Old table 12
table_B <- read_rdata(here::here("report", "tables", "exec_summ_tables", "ssb_es.rda"))$table
# shorten name (removing "(billions of eggs)")
...
table_f |>
  ...
  gt::cols_width(gt::everything() ~ gt::pct(15))
