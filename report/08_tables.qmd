...
# manually round
table1[, 2:ncol(table1)] <- round(table1[, 2:ncol(table1)], 1)
...
#| echo: false
#| warning: false
#| tbl-cap: "Estimated Dirichlet-multinomial parameters and the corresponding data weights derived using the McAllister-Ianelli and Francis methods."
