...
The equilibrium yield plot is shown in @fig-h, based on a steepness value fixed at 0.720. The predicted maximum sustainable yield under the assumptions of this assessment occurs near 25% of equilibrium unfished spawning biomass.
...
header_df <- data.frame(
  keys = names(table_f),
  line1 = c("Year", "OFL (mt) (termed ABC prior to 2011)", "ABC (mt)", "ACL (mt)", "Estimated Total Catch (mt)", "Estimated Total Mortality (mt)"),
  # line2 = c(" ", "(number in thousands)", " Interval ", "Deviation", " Interval "),
  stringsAsFactors = FALSE
)
...
#| warning: false
#| eval: true
#| fig-cap: "Equilibrium yield curve for the base case model and associated target and limit reference points. Values are based on 2019 fishery selectivity and distribution with steepness fixed at 0.720. The fraction unfished is relative to unfished spawning biomass."
#| out.width: "90%"
#| fig-align: "center"
