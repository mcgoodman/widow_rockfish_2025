...
table1 <- read.csv(file.path(here::here(),"report/tables/table_1.csv"))
...
flextable(table1, col_keys = names(table1)) %>%
 ...
 colformat_num(j = 1, big.mark = "", digits = 0) %>% port_tab_style %>% width(width = 0.5)
...
flextable(table4_data) %>%
 ...
 # # Set font
 # font(fontname = "Times New Roman", part = "all") %>%
 colformat_num(j = 1, big.mark = "", digits = 0) %>% port_tab_style
...
flextable(table9, col_keys = names(table9)) %>%
 ...
 # autofit() %>%
 colformat_num(j = 1, big.mark = "", digits = 0) %>%
 port_tab_style() %>% width(width = 0.5)
...
flextable(table10, col_keys = names(table10)) %>%
 ...
 # autofit() %>%
 colformat_num(j = 1, big.mark = "", digits = 0) %>%
 land_tab_style() %>% width(width = 0.5)
...
flextable(table23) %>% port_tab_style %>%
 #set_header_df(mapping = header_df, key = "keys") %>% 
 # border(part = "all") %>% 
 align(align = "left", j=2) %>% 
 # font(fontname = "Times New Roman", part = "all") %>% 
...
# Function for consistent table styling 
flextable(table24) %>% port_tab_style %>%
 # border(part = "all") %>% 
...
# Function for consistent table styling 
flextable(table26) %>% land_tab_style %>%
 # border(part = "all") %>% 
 # font(fontname = "Times New Roman", part = "all") %>% 
 # bold(part = "header")%>% 
 # align(align = "center", j = c(2,3))%>% 
 # italic(i=c(6,11,13,16),italic=TRUE)%>%
 bold(i=c(6,11,16),bold=TRUE)%>% hline(i = c(5, 6, 10, 11, 15, 16)) %>%
...
# Function for consistent table styling 
flextable(table28) %>% port_tab_style %>%
 # border(part = "all") %>% 
 # font(fontname = "Times New Roman", part = "all") %>% 
 # bold(part = "header")%>% 
 # align(align = "center", j = c(2,3))%>% 
...
# Add a row that spans all columns (like a section header)
 flextable(table29) %>% land_tab_style %>% colformat_num(i = 15, j = 1:13, digits = 0) %>%
 ...
 bold(i = likelihood_row, part = "body") %>% hline(i = c(likelihood_row-1, likelihood_row)) %>% width(width = 0.6)
...
# Add a row that spans all columns (like a section header)
 flextable(table30) %>% land_tab_style %>% 
...
# Add a row that spans all columns (like a section header)
 flextable(table31) %>% land_tab_style %>% 
 colformat_num(i = 15, j = 1:6, digits = 0) %>%
 colformat_num(j = 2:6, digits = 3) %>%
 compose(i = likelihood_row, j = 1, value = as_paragraph("Difference from Base Model Likelihood")) %>%
...
# Add a row that spans all columns (like a section header)
 flextable(table32) %>% land_tab_style %>% 
 colformat_num(i = 15, j = 1:6, digits = 0) %>%
 colformat_num(j = 2:6, digits = 3) %>%
 compose(i = likelihood_row, j = 1, value = as_paragraph("Difference from Base Model Likelihood")) %>%
...
# Add a row that spans all columns (like a section header)
 flextable(table33) %>% land_tab_style %>% 
 colformat_num(i = 15, j = 1:6, digits = 0) %>%
 colformat_num(j = 2:6, digits = 3) %>%
 compose(i = likelihood_row, j = 1, value = as_paragraph("Difference from Base Model Likelihood")) %>%
...
# Add a row that spans all columns (like a section header)
 flextable(table34) %>%land_tab_style %>% 
 colformat_num(i = 15, j = 1:6, digits = 0) %>%
 colformat_num(j = 2:6, digits = 3) %>%
 compose(i = likelihood_row, j = 1, value = as_paragraph("Difference from Base Model Likelihood")) %>%
 merge_at(i = likelihood_row, j = 1:ncol(table34), part = "body") %>%
 align(i = likelihood_row, j = 1:ncol(table34), align = "center", part = "body") %>%
 bold(i = likelihood_row, part = "body") %>% hline(i = c(likelihood_row-1, likelihood_row)) %>% width(width = 0.5)
 # compose(i = likelihood_row, j = 1, value = as_paragraph("Difference from Base Model Likelihood")) %>%
 # merge_at(i = likelihood_row, j = 1:ncol(table34), part = "body") %>%
 # align(i = likelihood_row, j = 1:ncol(table34), align = "center", part = "body") %>%
...
# Function for consistent table styling 
flextable(table35) %>% port_tab_style() %>%
 # border(part = "all") %>% align(align = "left", j=2) %>% 
 # font(fontname = "Times New Roman", part = "all") %>% 
 # align(align = "center", part = "all") %>%
 # bold(part = "header")%>% border(border.top = my_border, i = 1) %>% 
