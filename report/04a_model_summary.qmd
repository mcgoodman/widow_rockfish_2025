...
The assessment followed the similar model structure as the 2015 benchmark assessment [@hicks_status_2015] and 2019 update assessment [@adams_status_2019]. The changes made to the previous assessment model occurred in two stages, an update assessment reviewed in August 2025 and a second round of changes that did not follow the update Terms of References which were reviewed at a supplemental meeting in October 2025. These changes are described in two separate groups.

Initial changes for August 2025 update:
...
Additional changes to the data for the January 2026 model:
- **The fleet structure was simplified.** The landings from fleets with very small catches (hook-and-line and net) were added to the bottom trawl landings and the composition data and discard data from the hook-and-line and net fleets were removed from the model.
- **Use external estimates of discards rather than estimate within the model**. For the years 1982-2001, landings were scaled using discard rates estimated from the Pikitch and EDCP data and for the years 2002-2023, GEMM estimates of discards were used. The 2024 values were set to the average from the GEMM estimates for the period 2021--2023. All retention parameters were removed from the model.
- **The data weighting was updated.** The data weighting approach was changed to match recent practices, including the use of the Francis rather than McAllister-Ianelli approach, and no longer including a 50% additional reduction in weights.
- **Various additional refinements made.** 
  - The landings from Washington were updated to reflect a recent catch-reconstruction that was included as a sensitivity analysis in the August base model.
  ...
  - The foreign catch from the years 1968--1976 was moved from the hake fleet to the bottom trawl fleet. 
  - Change the timing of the final block on midwater trawl selectivity from 2011 to 2017

Comparison time series estimates from the 2019 update assessment model and this 2025 model are shown in @fig-base_19_25_bratio to @fig-base_19_25_recdevs. See "Model Bridging" section for further details.
