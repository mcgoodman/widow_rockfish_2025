---
title: |
  Proposed new widow rockfish base model  
  \linebreak
  and changes from August 2025
author: 
  - name: Ian G. Taylor^1^
...
# Bridging from the August 2025 model to the new proposed base model {#sec-bridging}
...
# Diagnostics from the new proposed base model
...
# Reference points and projections for new proposed base model
