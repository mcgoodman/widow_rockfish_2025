...
load(here::here("report", "tables", "exec_summ_tables", "recent_management.rda"))
...
#Old table 10
table10 <- read.csv(here::here("report", "tables", "length_trips_nonhake.csv"))
#Remove periods
...
#Old table 11
table11 <- read.csv(here::here("report", "tables", "length_samples_nonhake.csv"))
...
#Old table 12
table12 <- read.csv(here::here("report", "tables", "lengths_hake.csv"))
...
#Old table 13
table13 <- read.csv(here::here("report", "tables", "age_trips_nonhake.csv"))
...
#Old table 13
table14 <- read.csv(here::here("report", "tables", "age_samples_nonhake.csv"))
...
table6_data <- read.csv(here::here("data_provided", "2019_assessment", "triennial_ranges.csv"))
...
table7_nwfsc_data <- read.csv(here::here("data_provided", "2019_assessment", "wcgbts_strata.csv"))

table7_triennial_data <- read.csv(here::here("data_provided", "2019_assessment", "triennial_strata.csv"))
...
table20 <- read.csv(here::here("data_provided", "2019_assessment", "aging_error.csv"))
