...
## Liklihood profiles 
nat_M_male <- read.csv(here("models","diagnostics","2025 base model_profile_NatM_uniform_Mal_GP_1","profile_NatM_uniform_Mal_GP_1_results.csv"))
nat_M_female <- read.csv(here("models","diagnostics","2025 base model_profile_NatM_uniform_Fem_GP_1","profile_NatM_uniform_Fem_GP_1_results.csv"))
steepness <- read.csv(here("models","diagnostics","2025 base model_profile_SR_BH_steep","profile_SR_BH_steep_results.csv"))
ln_R0 <- read.csv(here("models","diagnostics","2025 base model_profile_SR_LN(R0)","profile_SR_LN(R0)_results.csv"))


male_m_min <- nat_M_male[nat_M_male$likelihood == min(nat_M_male$likelihood),"parameter_value"]
female_m_min <- nat_M_female[nat_M_female$likelihood == min(nat_M_female$likelihood),"parameter_value"]
sr_min <- ln_R0[ln_R0$likelihood == min(ln_R0$likelihood),"parameter_value"][[1]]
steep_min <- steepness[steepness$likelihood == min(steepness$likelihood),"parameter_value"]
